...
const Material MATERIALS[MATERIAL_COUNT] = {
	...
	[MATERIAL_GRASS]		 = { .color = COLOR_GRASS, .solid = true, .opaque = true },
	[MATERIAL_GROUND]		 = { .color = COLOR_DIRT, .solid = true, .opaque = true },
	[MATERIAL_WOOD]			 = { .color = COLOR_WOOD, .solid = true, .opaque = true, .flammable = true },
	[MATERIAL_ROCK]			 = { .color = COLOR_STONE, .solid = true, .opaque = true, .requiresTool = true },
